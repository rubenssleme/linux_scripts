...
fromTrinityDIR=/media/trinity_share/files/
toOnedriveDIR=/media/onedrive_share/files/
...
rsync -azhu --log-file='logs/rsync.log' --delete-after --ipv6 --progress  --exclude='$RECYCLE.BIN/' --exclude='/System Volume Information/' --exclude='DumpStack.log.tmp' --exclude='desktop.ini' --exclude='ext_hd'  "$fromTrinityT"  "$toOnedriveO"
