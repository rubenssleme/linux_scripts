...
destAnyVideo="/media/trinity_share/files_bkp/"
...
echo "Rsync in ${day_week} to $destAnyVideo"
date
echo
...
rsync -azhu --delete-after --ipv6 --progress  --exclude='$RECYCLE.BIN/' --exclude='/System Volume Information/' --exclude='files_bkp'  "$dirAnyVideo"  "$destAnyVideo${day_week}"
